...
points <-honor_roll_html %>% html_nodes("td:nth-child(3)") %>% html_text() %>% data.frame() %>% rename(points = ".")
...
library(tidyverse)
hospital_honor_roll_2016[,3] <- as.numeric(as.character(hospital_honor_roll_2016[,3]))
